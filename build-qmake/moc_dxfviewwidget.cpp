...
template <> constexpr inline auto DxfViewWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13DxfViewWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(int, const QPointF &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::QPointF, 5 },
        }}),
        ...
        QtMocHelpers::SignalData<void(const DxfDocument &, const DxfDocument &, const QString &)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 11, 12 }, { 0x80000000 | 11, 13 }, { QMetaType::QString, 14 },
        }}),
    };
